...
public class ProductService {
    ...
    public Page<Product> findByPlatformAndName(String platform, String name, Pageable pageable) {
        return productRepository.findByPlatformContainingIgnoreCaseAndNameContainingIgnoreCase(platform, name, pageable);
    }

    public Page<Product> findByPlatform(String platform, Pageable pageable) {
        return productRepository.findByPlatformContainingIgnoreCase(platform, pageable);
    }
